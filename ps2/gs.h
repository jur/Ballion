...
// Values for ZTST in zbuf_1 and zbuf_2
#define ZTST_ENABLE 0	// enable zbuffer update
#define ZTST_DISABLE 1	// disable zbuffer update
...
// Values for alpha
#define ALPHA_SOURCE 0
#define ALPHA_DESTINATION 1
#define ALPHA_ZERO 2
